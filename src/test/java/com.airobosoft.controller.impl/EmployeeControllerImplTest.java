package com.airobosoft.controller.impl;
...
import com.airobosoft.util.EmployeeBuilder;
...
public class EmployeeControllerImplTest {
    ...
    public void getById() throws Exception {
        ...
        Mockito.when(employeeService.findById(ArgumentMatchers.anyInt())).thenReturn(Optional.of(EmployeeBuilder.getEntity()));
